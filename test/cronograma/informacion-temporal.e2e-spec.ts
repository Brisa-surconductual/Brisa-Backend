...
import { ConsultarInformacionTemporalUsuarioUseCase } from '../../src/modules/cronograma/application/use-cases/consultar-informacion-temporal-usuario.use-case';
import { ModuloSistema } from '../../src/modules/cronograma/domain/entities/modulo-sistema.entity';
import { CronogramaActivoUsuarioNoEncontradoException } from '../../src/modules/cronograma/domain/exeption/cronograma-activo-usuario-no-encontrado.exception';
